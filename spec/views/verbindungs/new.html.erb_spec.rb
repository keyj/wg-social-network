...
describe "verbindungs/new.html.erb" do
  before(:each) do
    assign(:verbindung, stub_model(Verbindung,
      :msn_id => "MyString",
      :rechnung_id => 1,
      :verbindung_id => 1,
      :datum_raw => "MyString",
  ...
  it "renders new verbindung form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => verbindungs_path, :method => "post" do
